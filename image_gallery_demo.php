...
<main class="main-container">
    <div class="container">
        ...
        <div class="row photos">
            ...
            ?>
                <div class="col-sm-6 col-md-4 col-lg-4 item" style="height: 260px;"><a href="ejnff/latest_updates/<?php echo $result['image']; ?>" data-lightbox="photos"><img class="img-fluid" src="ejnff/latest_updates/<?php echo $result['image']; ?>"></a>
