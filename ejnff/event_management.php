...
for($i=0;$i<$countfiles;$i++){
  ...
  // Upload file
  if(move_uploaded_file($_FILES['event']['tmp_name'][$i],'event_management/'.$filename))
  {
  $insert=mysqli_query($conn,"INSERT INTO `event_management`(`title`,`description`,`image`) VALUES ('".$_POST['title']."','".$_POST['description']."','".$filename."')");
  var_dump($insert);
  }
