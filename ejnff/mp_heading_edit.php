...
if(!mysqli_fetch_array(
    mysqli_query($conn,sprintf(
        'select * from mainpage_headings where id=%s;',mysqli_real_escape_string($conn,$_GET['id'])
    ))
...
if(isset($_POST['submit']))
{
    ...
    $insert=mysqli_query($conn,sprintf(
        'UPDATE mainpage_headings set title="%s" where id=%s;',mysqli_real_escape_string($conn,$_POST['title']),
...
<div class="content-wrapper">
    <div class="container">
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">HEADING EDITING</h4>
