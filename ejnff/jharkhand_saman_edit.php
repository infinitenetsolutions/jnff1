...
if (isset($_POST['submit'])) {
    ...
    if (!empty($_FILES['file']['name'])) {
        $targetfolder = "jharkhand_saman/";
        $file = $_FILES['file']['name'];
        move_uploaded_file($_FILES['file']['tmp_name'], $targetfolder . $file);



        $insert = mysqli_query($conn, "UPDATE `jharkhand_saman` SET `title`= '" . $_POST['title'] . "',`description`='" . $_POST['description'] . "',`image`='" . $file . "' WHERE id='" . $_GET['id'] . "'");
        //var_dump($insert);


    } else {
        $insert = mysqli_query($conn, "UPDATE `jharkhand_saman` SET `title`= '" . $_POST['title'] . "',`description`='" . $_POST['description'] . "'WHERE id='" . $_GET['id'] . "'");
    }
    if ($insert) {
        header('location:jharkhand_saman.php');
    }
}



$sel_news = mysqli_query($conn, "SELECT * from jharkhand_saman where id='" . $_GET['id'] . "' ");
                            ...
                            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <img id="blah" src="jharkhand_saman/<?php echo $result['image']; ?>" style="height: 100px;width: 100px;">
                                    </div>
                                </div>
                                <div class="form-group">
