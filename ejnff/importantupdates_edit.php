...
if(isset($_POST['submit']))
{
    ...
    {
        $targetfolder = "important_updates/";
        $file =$_FILES['file']['name'];
        move_uploaded_file($_FILES['file']['tmp_name'] , $targetfolder . $file);

    
  
  $insert=mysqli_query($conn,"UPDATE `important_updates` SET `title`= '".$_POST['title']."',`important_updates`='".$file."' WHERE id='".$_GET['id']."'");
  //var_dump($insert);
...
{
    $insert=mysqli_query($conn,"UPDATE `important_updates` SET `title`= '".$_POST['title']."' WHERE id='".$_GET['id']."'");
}
...
$sel_news = mysqli_query($conn, "SELECT * from important_updates where id='" . $_GET['id'] . "' ");
...
<div class="content-wrapper">
    <div class="container">
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header-line">Impotent UPDATES</h4>
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <img id="blah"  src="important_updates/<?php echo $result['important_updates'];?>" style="height: 100px;width: 100px;">
                                </div>
                            </div>
                                <div class="form-group">
