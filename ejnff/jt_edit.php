...
if (isset($_POST['submit'])) {
    ...
    if (!empty($_FILES['file']['name'])) {
        ...
        $insert = mysqli_query($conn, "UPDATE `jt` SET `title`= '" . $_POST['title'] . "',`description`='" . $_POST['description'] . "',`image`='" . $file . "' WHERE id='" . $_GET['id'] . "'");
        //var_dump($insert);


    } else {
        $insert = mysqli_query($conn, "UPDATE `jt` SET `title`= '" . $_POST['title'] . "',`description`='" . $_POST['description'] . "'WHERE id='" . $_GET['id'] . "'");
    }
    if ($insert) {
        header('location:jt.php');
    }
}



$sel_news = mysqli_query($conn, "SELECT * from jt where id='" . $_GET['id'] . "' ");
                            ...
                            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <img id="blah" src="jt/<?php echo $result['image']; ?>" style="height: 100px;width: 100px;">
                                    </div>
                                </div>
                                <div class="form-group">
