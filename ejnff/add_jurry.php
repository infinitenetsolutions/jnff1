...
if (isset($_POST['submit'])) {
    ...
    for ($i = 0; $i < $countfiles; $i++) {
        ...
        // Upload file
        if (move_uploaded_file($_FILES['event']['tmp_name'][$i], 'jurry/' . $filename)) {
            $title= $_POST['title'];
           ...
           // $insert = mysqli_query($conn, "INSERT INTO `jurry`(`title`,`description`,`image`) VALUES ('" . $_POST['title'] . "','" . $_POST['description'] . "','" . $filename . "')");
             ...
             $insert1 = mysqli_query($conn , "INSERT INTO `jurry`(`title`, `description`, `image`) VALUES('$title','$description','$filename')");
            echo '<pre>';
            var_dump($insert1);
    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="row pad-botm">
                <div class="col-md-12">
                    <h4 class="header-line">ADD JURRY</h4>
