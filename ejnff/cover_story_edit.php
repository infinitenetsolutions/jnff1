...
if (isset($_POST['submit'])) {
    ...
    if (!empty($_FILES['file']['name'])) {
        $targetfolder = "cover_story/";
        $file = $_FILES['file']['name'];
        move_uploaded_file($_FILES['file']['tmp_name'], $targetfolder . $file);



        $insert = mysqli_query($conn, "UPDATE `cover_story` SET `title`= '" . $_POST['title'] . "',`description`='" . $_POST['description'] . "',`image`='" . $file . "' WHERE id='" . $_GET['id'] . "'");
        //var_dump($insert);


    } else {
        $insert = mysqli_query($conn, "UPDATE `cover_story` SET `title`= '" . $_POST['title'] . "',`description`='" . $_POST['description'] . "'WHERE id='" . $_GET['id'] . "'");
    }
    if ($insert) {
        header('location:cover_story.php');
    }
}



$sel_news = mysqli_query($conn, "SELECT * from cover_story where id='" . $_GET['id'] . "' ");
    ...
    <div class="content-wrapper">
        <div class="container">
            <div class="row pad-botm">
                <div class="col-md-12">
                    <h4 class="header-line">Cover Story</h4>
                            ...
                            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <img id="blah" src="cover_story/<?php echo $result['image']; ?>" style="height: 100px;width: 100px;">
                                    </div>
                                </div>
                                <div class="form-group">
